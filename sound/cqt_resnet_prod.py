...
path_img = "G:/kaggle/sound/cqt_img/png_train64_full/"
path_img_test = "G:/kaggle/sound/cqt_img/png_test64_full/"
...
np.save("G:/kaggle/sound/cqt_img/png_train64_full/trainX.npy", X_train)
np.save("G:/kaggle/sound/cqt_img/png_train64_full/y_train.npy", y_train)
"""
#X_test = []
...
#np.save("G:/kaggle/sound/cqt_img/png_test64_full/X_test.npy", X_test)
"""
X_train = np.load("G:/kaggle/sound/cqt_img/png_train64_full/trainX.npy")
y_train = np.load("G:/kaggle/sound/cqt_img/png_train64_full/y_train.npy")
"""
...
X_train = np.load("G:/kaggle/sound/cqt_img/png_train64_full/trainX.npy")
X_test = np.load("G:/kaggle/sound/cqt_img/png_test64_full/X_test.npy")
...
for i, (train_split, val_split) in enumerate(skf):
    ...
    callbacks_list=[
        ...
        ModelCheckpoint(f"cqt_resnet18_best_loss_{i}.h5", monitor='val_loss', verbose=1, save_best_only=True)
    ]
    ...
    model.load_weights(f"cqt_resnet18_best_loss_{i}.h5")
