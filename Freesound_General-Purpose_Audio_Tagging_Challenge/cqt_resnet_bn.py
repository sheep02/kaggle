...
path_img = r"G:\kaggle\sound\img_cqt\png_train64_full"
path_img_test = r"G:\kaggle\sound\img_cqt\png_test64_full"
...
for i, (train_split, val_split) in enumerate(skf):
    ...
    callbacks_list=[
        ...
        ModelCheckpoint(f"cqt_resnet18_best_loss_{i}.h5", monitor='val_acc', verbose=1, save_best_only=True)
    ]
...
test = pd.read_csv("G:/kaggle/sound/_dl/sample_submission.csv")
test['label'] = predicted_labels
test[['fname', 'label']].to_csv("bn_cqtsubmission.csv", index=False)
